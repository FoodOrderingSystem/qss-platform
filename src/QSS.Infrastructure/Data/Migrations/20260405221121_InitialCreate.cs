        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LearningMaterials_AspNetUsers_UploadedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UsedByUserId = table.Column<string>(type: "TEXT", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MedicationUsageLogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MedicationUsageLogs_AspNetUsers_UsedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RoomInventoryItems_Materials_MaterialId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LearningProgress_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LearningProgress_LearningMaterials_LearningMaterialId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MentionedUserId = table.Column<string>(type: "TEXT", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    IsDeleted = table.Column<bool>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TaskComments_AspNetUsers_MentionedUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LearningMaterials_UploadedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MedicationUsageLogs_UsedByUserId",
                table: "MedicationUsageLogs",
                column: "UsedByUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoomInventoryItems_MaterialId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskComments_MentionedUserId",
                table: "TaskComments",
